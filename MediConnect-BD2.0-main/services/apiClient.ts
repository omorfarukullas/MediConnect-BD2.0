...
class ApiService {
  ...
  async getAppointments() {
    return this.http.get('/v2/appointments');
  }

  async createAppointment(data: any) {
    return this.http.post('/v2/appointments', data);
  }

  async getAppointmentById(id: number) {
    return this.http.get(`/v2/appointments/${id}`);
  }

  async updateAppointment(id: number, data: any) {
    return this.http.put(`/v2/appointments/${id}`, data);
  }

  async cancelAppointment(id: number) {
    return this.http.delete(`/v2/appointments/${id}`);
  }
